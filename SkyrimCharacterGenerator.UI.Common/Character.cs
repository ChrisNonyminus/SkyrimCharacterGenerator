...
namespace SkyrimCharacterGenerator.UI.Common
{
    public class Character
    {
        ...
        public static Character Generate(Options options)
        {
            ...
            if (options.UsingFactionReps)
            {
                ...
                for (Faction faction = Faction.Folk; (int)faction < 14; faction++)
                {
                    ...
                    {
                        character.DefaultReputations[faction] = (Reputation)random.Next(5);
                    }
                }
                var baserepuations = character.DefaultReputations;
